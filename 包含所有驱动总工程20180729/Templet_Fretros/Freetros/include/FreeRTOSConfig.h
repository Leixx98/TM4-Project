...
#define configCPU_CLOCK_HZ                  ( ( unsigned long ) 120000000 )            //系统时钟120M
#define configTICK_RATE_HZ                  ( ( TickType_t ) 1000 )                               //系统节拍1000，即1ms
...
#define configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY 6
 //TM4C129控制中断优先级的共三位，一共有8个优先级，所以最低优先级为7，而优先级位为高3位，共左移5位
