...
#ifndef __ADS1115_01_H
#define __ADS1115_01_H
...
/****************************************************************8******/
#define ADS1115_01_SCL_SET        GPIOPinWrite(GPIO_PORTK_BASE, GPIO_PIN_1, GPIO_PIN_1);
#define ADS1115_01_SCL_CLR        GPIOPinWrite(GPIO_PORTK_BASE, GPIO_PIN_1, 0);                 
#define ADS1115_01_SDA_SET        GPIOPinWrite(GPIO_PORTK_BASE, GPIO_PIN_0, GPIO_PIN_0);
#define ADS1115_01_SDA_CLR        GPIOPinWrite(GPIO_PORTK_BASE, GPIO_PIN_0, 0);
#define ADS1115_01_SDA_IN         GPIOPinRead(GPIO_PORTK_BASE,GPIO_PIN_0)

////ADS1115_01_01_SDAPort_IN()和ADS1115_01_01_SDAPort_OUT()函数定义在.c中，适应不同的单片机，更改IO口方向
...
void ADS1115_01_Ack(void);
void ADS1115_01_Nack(void);
unsigned char ADS1115_01_Check(void);
void ADS1115_01_Write_1_Byte(unsigned char DataByte);
unsigned char ADS1115_01_Write_N_Byte(unsigned char *writebuffer,unsigned char n);
unsigned char ADS1115_01_Read_1_Byte(void);
void ADS1115_01_Read_N_Byte(unsigned char*readbuff, unsigned char n);
