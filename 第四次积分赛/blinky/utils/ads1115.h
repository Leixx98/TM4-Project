...
/****************************************************************8******/
#define ADS1115_SCL_SET        GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_3, GPIO_PIN_3);
#define ADS1115_SCL_CLR        GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_3, 0);                 
#define ADS1115_SDA_SET        GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_2, GPIO_PIN_2);
#define ADS1115_SDA_CLR        GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_2, 0);
#define ADS1115_SDA_IN            GPIOPinRead(GPIO_PORTA_BASE,GPIO_PIN_2)

//ADS1115_SDAPort_IN()?ADS1115_SDAPort_OUT()?????.c?,????????,??IO???


#define AD_START   GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_4, 0);
#define AD_END       GPIOPinWrite(GPIO_PORTA_BASE, GPIO_PIN_4,GPIO_PIN_4);
